...
def extract_mobile_number(text, custom_regex=None):
    ...
    mob_num_regex = r'^\+?\d(?:[\\|/ -]?)?(?:[\(\)])?\d(?:[\(\)])?(?:[\\|/ -]?)?(?:[\(\)])?\d(?:[\(\)])?(?:[\\|/ -]?)?(?:[\(\)])?\d(?:[\(\)])?(?:[\\|/ -]?)?(?:[\(\)])?\d(?:[\(\)])?(?:[\\|/ -]?)?(?:[\(\)])?\d(?:[\(\)])?(?:[\\|/ -]?)?(?:[\(\)])?\d(?:[\(\)])?(?:[\\|/ -]?)?(?:[\(\)])?\d(?:[\(\)])?(?:[\\|/ -]?)?(?:[\(\)])?\d(?:[\(\)])?(?:[\\|/ -]?)?(?:[\(\)])?\d(?:[\(\)])?(?:[\\|/ -]?)?(?:[\(\)])?\d(?:[\(\)])?(?:[\\|/ -]?)?(?:[\(\)])?$'
    #mob_num_regex = r'\+(9[976]\d|8[987530]\d|6[987]\d|5[90]\d|42\d|3[875]\d|2[98654321]\d|9[8543210]|8[6421]|6[6543210]|5[87654321]|4[987654310]|3[9643210]|2[70]|7|1)\s?\(?\d{3}\)?\s?\d{3}[-\s]?\d{2}[-\s]?\d{2}$'
    if not custom_regex:
        #mob_num_regex = r'''(\d{3}[-\.\s]??\d{3}[-\.\s]??\d{4}|\(\d{3}\)
        #                [-\.\s]*\d{3}[-\.\s]??\d{4}|\d{3}[-\.\s]??\d{4})'''
        phone = re.search(re.compile(mob_num_regex), text)
        print("!!!!!!!!!!!", phone)
    else:
        phone = re.findall(re.compile(mob_num_regex), text)
    if phone:
        number = ''.join(phone.group(0))
        return number
